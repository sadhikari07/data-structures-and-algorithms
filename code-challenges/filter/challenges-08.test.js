...
const filterStringsWithVowels = (arr) => {
  return arr.filter(element => element.match(/[aeiou]/));
  // Solution code here...
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let newArr = [];
  newArr = arr.filter(element => element.baseStat>minBaseStat);
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  return arr.filter(element => !(element.hasOwnProperty('children'))
    );
};
